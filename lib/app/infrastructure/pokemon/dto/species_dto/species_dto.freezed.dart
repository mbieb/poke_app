...
/// @nodoc
@JsonSerializable()
class _$_SpeciesDto extends _SpeciesDto {
  const _$_SpeciesDto({this.name}) : super._();
...
abstract class _SpeciesDto extends SpeciesDto {
  const factory _SpeciesDto({final String? name}) = _$_SpeciesDto;
